...
% Define custom enumeration labels for hierarchical numbering
...
\begin{enumerate}
\item The official name of the organization will be – The Association of Mathematical and Computer Sciences Students.

\item The Association of Mathematical and Computer Sciences Students (AMACSS).
\end{enumerate}
