...
\newlist{constitutionlist}{enumerate}{3}
\setlist[constitutionlist]{label=\arabic*.}
\setlist[constitutionlist,1]{label=\thesection.\arabic*.}
\setlist[constitutionlist,2]{label=\thesection.\arabic*.\arabic*.}
\setlist[constitutionlist,3]{label=\thesection.\arabic*.\arabic*.\arabic*.}
